...
from latency_map.create_latency_map import RegisterOperand, ImmOperand, MemoryOperand, AgenOperand
from latency_map.op_types import Immediate, Memory, Register, Label
from latency_map.string_matching import one_op_regex, relative_from_compound_op_regex, compound_op_regex, two_ops_regex, \
    three_ops_regex, register_regex, relative_from_register_regex, label_relative_from_register_regex, imm_values_regex, \
    labels_regex
