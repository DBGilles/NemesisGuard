...
from latency_map.string_matching import relative_from_compound_op_regex, compound_op_regex, register_regex, \
    relative_from_register_regex, label_relative_from_register_regex, imm_values_regex, \
    labels_regex
